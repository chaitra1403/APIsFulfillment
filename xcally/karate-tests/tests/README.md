...
- Feature file is at: `xcally/karate-tests/tests/listener_communicationMessage_post.feature`
...
```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar xcally/karate-tests/tests/listener_communicationMessage_post.feature
```
