...
- Feature file is at: `karate-tests/tests/appointmentConfirmation_post.feature`
...
```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar karate-tests/tests/appointmentConfirmation_post.feature
```
